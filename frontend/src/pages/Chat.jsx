...
// FullScreenChat 组件，独立作为一个全屏对话页面
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Typography variant="h6" sx={{ fontWeight: 'bold' }}>AI助手对话</Typography>
          {/* 可以在这里放置一个关闭按钮，或者通过路由切换实现返回 */}
          <IconButton
            size="large"
            // onClick={onClose} // 如果页面有路由，可以调用 history.goBack()
            sx={{ color: "#fff" }}
            title="关闭"
          >
            <CloseIcon />
